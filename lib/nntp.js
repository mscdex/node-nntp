...
NNTP.prototype.connect = function(options) {
  ...
  var socket = this._socket = Socket ? new Socket() : new window.Socket();
  this._socket.setTimeout(this.options.timeout ? this.options.timeout : 0);
...
NNTP.prototype.post = function(msg, headers, cb) {
